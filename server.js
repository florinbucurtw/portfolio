...
function populateETFSectors() {
  const etfSectorsData = [
    // IE00B8GKDB10 - Vanguard FTSE All-World High Dividend Yield
    {
      ...
      sectors: [
        { name: 'Financials', pct: 28.06 },
        { name: 'Industrials', pct: 11.47 },
        { name: 'Health Care', pct: 10.01 },
        { name: 'Consumer Staples', pct: 8.88 },
        { name: 'Energy', pct: 7.84 },
        { name: 'Consumer Discretionary', pct: 7.43 },
        { name: 'Information Technology', pct: 6.91 },
        { name: 'Materials', pct: 6.31 },
        { name: 'Communication Services', pct: 4.9 },
        { name: 'Utilities', pct: 4.28 },
        { name: 'Real Estate', pct: 3.91 },
      ],
    },
    // IE00B3RBWM25 - Vanguard FTSE All-World
    {
      ...
      sectors: [
        { name: 'Technology', pct: 27.7 },
        { name: 'Financials', pct: 15.33 },
        { name: 'Consumer Discretionary', pct: 10.62 },
        { name: 'Industrials', pct: 9.96 },
        { name: 'Health Care', pct: 9.21 },
        { name: 'Consumer Staples', pct: 7.09 },
        { name: 'Communication Services', pct: 6.4 },
        { name: 'Energy', pct: 4.67 },
        { name: 'Materials', pct: 3.71 },
        { name: 'Utilities', pct: 2.27 },
        { name: 'Real Estate', pct: 2.04 },
      ],
    },
    // NL0011683594 - VanEck Morningstar Developed Markets Dividend Leaders
    {
      ...
      sectors: [
        { name: 'Financials', pct: 40.92 },
        { name: 'Health Care', pct: 16.27 },
        { name: 'Utilities', pct: 8.16 },
        { name: 'Energy', pct: 8.1 },
        { name: 'Communication Services', pct: 7.0 },
        { name: 'Consumer Staples', pct: 6.18 },
        { name: 'Materials', pct: 5.42 },
        { name: 'Industrials', pct: 4.14 },
        { name: 'Real Estate', pct: 2.81 },
      ],
    },
    // IE000M7V94E1 - VanEck Uranium and Nuclear Technologies
    {
      ...
      sectors: [
        { name: 'Energy', pct: 38.52 },
        { name: 'Industrials', pct: 31.61 },
        { name: 'Financials', pct: 5.06 },
        { name: 'Technology', pct: 1.0 },
        { name: 'Materials', pct: 23.81 },
      ],
    },
    // IE000OJ5TQP4 - HANetf Future of Defence
    {
      ...
      sectors: [
        { name: 'Industrials', pct: 61.28 },
        { name: 'Technology', pct: 31.3 },
        { name: 'Health Care', pct: 3.71 },
    ...
    // IE00BYWQWR46 - VanEck Video Gaming and eSports
    {
      ...
      sectors: [
        { name: 'Communication Services', pct: 69.4 },
        { name: 'Consumer Discretionary', pct: 16.78 },
        { name: 'Technology', pct: 5.98 },
        { name: 'Financials', pct: 7.84 },
      ],
    },
    // IE000YU9K6K2 - VanEck Space Innovators
    {
      ...
      sectors: [
        { name: 'Communication Services', pct: 24.86 },
        { name: 'Industrials', pct: 22.98 },
        { name: 'Technology', pct: 14.72 },
        { name: 'Consumer Discretionary', pct: 37.44 },
      ],
    },
    // IE00B5BMR087 - iShares Core S&P 500
    {
      ...
      sectors: [
        { name: 'Technology', pct: 36.7 },
        { name: 'Financials', pct: 10.94 },
        { name: 'Consumer Discretionary', pct: 10.64 },
        { name: 'Communication Services', pct: 10.05 },
        { name: 'Health Care', pct: 9.99 },
        { name: 'Industrials', pct: 7.67 },
        { name: 'Consumer Staples', pct: 5.62 },
        { name: 'Energy', pct: 3.39 },
        { name: 'Utilities', pct: 2.33 },
        { name: 'Materials', pct: 1.99 },
        { name: 'Real Estate', pct: 0.68 },
      ],
    },
    // IE00BGV5VN51 - Xtrackers Artificial Intelligence & Big Data
    {
      ...
      sectors: [
        { name: 'Technology', pct: 67.65 },
        { name: 'Communication Services', pct: 15.42 },
        { name: 'Financials', pct: 8.93 },
        { name: 'Consumer Discretionary', pct: 4.7 },
        { name: 'Industrials', pct: 3.3 },
      ],
    },
  ];

  const stmt = db.prepare(
    'INSERT INTO etf_sectors (isin, etf_name, sector_name, percentage) VALUES (?, ?, ?, ?)'
  );
...
function populateETFCountries() {
  const etfCountriesData = [
    // IE00B8GKDB10 - Vanguard FTSE All-World High Dividend Yield
    {
      ...
      name: 'Vanguard FTSE All-World High Dividend Yield',
      countries: [
        { name: 'United States', pct: 38.43 },
        { name: 'Japan', pct: 8.79 },
        { name: 'United Kingdom', pct: 6.47 },
        { name: 'Switzerland', pct: 4.4 },
        { name: 'Canada', pct: 4.09 },
        { name: 'Australia', pct: 3.92 },
        { name: 'Germany', pct: 3.47 },
        { name: 'France', pct: 3.42 },
        { name: 'China', pct: 2.76 },
        { name: 'Taiwan', pct: 2.47 },
        { name: 'South Korea', pct: 1.87 },
        { name: 'Other', pct: 19.91 },
      ],
    },
    // IE00B3RBWM25 - Vanguard FTSE All-World
    {
      ...
      name: 'Vanguard FTSE All-World',
      countries: [
        { name: 'United States', pct: 59.18 },
        { name: 'Japan', pct: 5.6 },
        { name: 'China', pct: 3.36 },
        { name: 'United Kingdom', pct: 3.08 },
        { name: 'Canada', pct: 2.86 },
        { name: 'France', pct: 2.54 },
        { name: 'Switzerland', pct: 2.28 },
        { name: 'Germany', pct: 2.08 },
        { name: 'India', pct: 1.96 },
        { name: 'Australia', pct: 1.86 },
        { name: 'Taiwan', pct: 1.77 },
        { name: 'South Korea', pct: 1.41 },
    ...
    // NL0011683594 - VanEck Morningstar Developed Markets Dividend Leaders
    {
      ...
      name: 'VanEck Morningstar Developed Markets Dividend Leaders',
      countries: [
        { name: 'France', pct: 14.12 },
        { name: 'United States', pct: 13.96 },
        { name: 'United Kingdom', pct: 11.07 },
        { name: 'Italy', pct: 9.42 },
        { name: 'Germany', pct: 8.23 },
        { name: 'Spain', pct: 7.63 },
        { name: 'Switzerland', pct: 6.95 },
        { name: 'Canada', pct: 5.49 },
        { name: 'Japan', pct: 4.93 },
        { name: 'Australia', pct: 4.15 },
        { name: 'Other', pct: 14.05 },
      ],
    },
    // IE000M7V94E1 - VanEck Uranium and Nuclear Technologies
    {
      ...
      name: 'VanEck Uranium and Nuclear Technologies',
      countries: [
        { name: 'United States', pct: 31.31 },
        { name: 'Canada', pct: 26.62 },
        { name: 'Japan', pct: 20.36 },
        { name: 'South Korea', pct: 5.49 },
        { name: 'France', pct: 5.45 },
        { name: 'Kazakhstan', pct: 5.32 },
    ...
    // IE000OJ5TQP4 - HANetf Future of Defence
    {
      ...
      name: 'HANetf Future of Defence',
      countries: [
        { name: 'United States', pct: 56.83 },
        { name: 'France', pct: 9.05 },
        { name: 'United Kingdom', pct: 7.46 },
        { name: 'Germany', pct: 6.22 },
        { name: 'Israel', pct: 4.2 },
        { name: 'Japan', pct: 3.83 },
        { name: 'Italy', pct: 3.81 },
        { name: 'South Korea', pct: 3.58 },
        { name: 'Canada', pct: 2.78 },
        { name: 'Other', pct: 2.24 },
      ],
    },
    // IE00BYWQWR46 - VanEck Video Gaming and eSports
    {
      ...
      name: 'VanEck Video Gaming and eSports',
      countries: [
        { name: 'United States', pct: 29.0 },
        { name: 'Japan', pct: 27.63 },
        { name: 'China', pct: 9.86 },
        { name: 'Taiwan', pct: 6.24 },
        { name: 'Poland', pct: 5.6 },
        { name: 'South Korea', pct: 5.56 },
        { name: 'United Kingdom', pct: 5.12 },
        { name: 'Sweden', pct: 4.92 },
        { name: 'Australia', pct: 4.94 },
        { name: 'Other', pct: 1.13 },
      ],
    },
    // IE000YU9K6K2 - VanEck Space Innovators
    {
      ...
      name: 'VanEck Space Innovators',
      countries: [
        { name: 'United States', pct: 43.83 },
        { name: 'South Korea', pct: 4.64 },
        { name: 'Japan', pct: 4.21 },
        { name: 'Taiwan', pct: 3.98 },
        { name: 'Luxembourg', pct: 11.03 },
        { name: 'France', pct: 10.42 },
        { name: 'United Kingdom', pct: 8.5 },
        { name: 'Canada', pct: 6.43 },
        { name: 'Bermuda', pct: 6.96 },
      ],
    },
    // IE00B5BMR087 - iShares Core S&P 500
    {
      ...
      name: 'iShares Core S&P 500',
      countries: [
        { name: 'United States', pct: 95.84 },
        { name: 'Ireland', pct: 1.32 },
        { name: 'Switzerland', pct: 1.04 },
        { name: 'United Kingdom', pct: 0.81 },
        { name: 'Netherlands', pct: 0.53 },
        { name: 'Other', pct: 0.46 },
      ],
    },
    // IE00BGV5VN51 - Xtrackers Artificial Intelligence & Big Data
    {
      ...
      name: 'Xtrackers Artificial Intelligence & Big Data',
      countries: [
        { name: 'United States', pct: 82.64 },
        { name: 'South Korea', pct: 6.01 },
        { name: 'Germany', pct: 3.59 },
        { name: 'China', pct: 1.5 },
        { name: 'France', pct: 1.44 },
        { name: 'Netherlands', pct: 1.4 },
        { name: 'Taiwan', pct: 1.26 },
        { name: 'Israel', pct: 1.24 },
        { name: 'Japan', pct: 0.92 },
      ],
    },
  ];
  ...
  const stmt = db.prepare(
    'INSERT INTO etf_countries (isin, etf_name, country_name, percentage) VALUES (?, ?, ?, ?)'
  );
...
async function fetchBNRRate() {
  try {
    ...
    if (eurMatch && eurMatch[1]) {
      ...
      console.log(
        `📈 BNR rate: ${bnrRate.toFixed(4)} → Adjusted: ${adjustedRate.toFixed(4)} (+0.09%)`
      );
      return adjustedRate;
    }
    return null;
    ...
    for (const altSymbol of alternatives) {
      try {
        const response = await fetch(
          `https://query1.finance.yahoo.com/v8/finance/chart/${altSymbol}`
        );
        const data = await response.json();
        ...
        if (data.chart && data.chart.result && data.chart.result[0]) {
          ...
          if (price != null && currency) {
            const isCrypto =
              symbol.endsWith('-USD') &&
              (symbol.includes('JASMY') ||
                symbol.includes('KAS') ||
                symbol.match(/^[A-Z]{3,}-USD$/));
            const rates = await getExchangeRates();
  ...
  try {
    ...
    try {
      ...
      const sp500Response = await fetch(
        'https://query1.finance.yahoo.com/v8/finance/chart/^GSPC?interval=1m&range=1d'
      );
    ...
    try {
      ...
      const betResponse = await fetch(
        'https://query1.finance.yahoo.com/v8/finance/chart/^BET-TRN.RO?interval=1m&range=1d'
      );
      ...
      if (!baseline) {
        db.run(
          ...
          function (err) {
            ...
            console.log(
              `✅ Created baseline (T0): Portfolio=${portfolio_balance}€, Deposits=${total_deposits}€, S&P=${sp500Price}, BET=${betPrice}`
            );
        ...
        const sp500Percent =
          baseline.sp500_price > 0 && sp500Price != null
            ? ((sp500Price - baseline.sp500_price) / baseline.sp500_price) * 100
            : 0;

        const betPercent =
          baseline.bet_price > 0 && betPrice != null
...
app.delete('/api/performance-snapshots/delete-range', (req, res) => {
  ...
  db.run(
    'DELETE FROM performance_snapshots WHERE id >= ? AND id <= ?',
    [fromId, toId],
    function (err) {
      if (err) {
...
app.post('/api/performance-baseline/reset', async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      if (sp500Data.chart?.result?.[0]) {
        sp500Price =
          sp500Data.chart.result[0].meta.regularMarketPrice ||
          sp500Data.chart.result[0].meta.previousClose;
      }
    } catch (err) {
      console.log('Could not fetch S&P 500 price:', err.message);
    }
    ...
    try {
      const betResponse = await fetch(
        'https://query1.finance.yahoo.com/v8/finance/chart/^BET-TRN.RO'
      );
      const betData = await betResponse.json();
      if (betData.chart?.result?.[0]) {
        betPrice =
          betData.chart.result[0].meta.regularMarketPrice ||
          betData.chart.result[0].meta.previousClose;
      }
    } catch (err) {
      console.log('Could not fetch BET-TR price:', err.message);
    }
...
app.get('/api/allocation/sectors', (req, res) => {
  ...
  db.all('SELECT * FROM stocks', [], (err, stocks) => {
    ...
    function sendSectorResponse() {
      ...
      const sectorArray = Object.keys(sectorAllocation)
        .map((sector) => ({
          name: sector,
...
app.get('/api/allocation/countries', (req, res) => {
  ...
  db.all('SELECT * FROM stocks', [], (err, stocks) => {
    ...
    function sendCountryResponse() {
      ...
      // Convert to array, normalize to 100%, and sort by percentage
      const countryArray = Object.keys(countryAllocation)
        .map((country) => ({
          name: country,
...
app.get('/api/quotes', async (req, res) => {
  try {
    ...
    const filtered = symbols.filter(
      (r) => r.symbol && r.symbol.trim() !== '-' && !r.symbol.toLowerCase().includes('cash')
    );
    const quoteResults = [];
...
async function cronSaveSnapshotOnce() {
  try {
    ...
    console.log(
      `✅ Cron snapshot: portfolio=${portfolioPercent.toFixed(4)}%, deposits=${depositsPercent.toFixed(4)}%, sp500=${sp500Percent.toFixed(4)}%, bet=${betPercent.toFixed(4)}%`
    );
  } catch (e) {
